      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-100 to-blue-50 py-8 px-2 sm:px-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:justify-between gap-2 mt-6">
            ...
            <button
              type="submit"
              className="w-full bg-navy text-white py-2 px-4 rounded-md font-bold hover:bg-gold hover:text-navy focus:bg-gold focus:text-navy transition-all duration-200 shadow-md hover:shadow-lg active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed"
              disabled={loading}
            >
